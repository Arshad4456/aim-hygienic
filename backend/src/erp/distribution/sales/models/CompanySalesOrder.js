...
const { PartySnapshotSchema, LineItemSchema, TotalsSchema, LedgerPostingSchema, StatusHistorySchema } = require("../../../common/files/models/documentParts");
...
const CompanySalesOrderSchema = new mongoose.Schema(
  {
    ...
    status: { type: String, trim: true, default: "draft", enum: ["draft", "approved", "reserved", "ready_to_dispatch", "dispatched", "received", "invoiced", "closed", "cancelled"] },
