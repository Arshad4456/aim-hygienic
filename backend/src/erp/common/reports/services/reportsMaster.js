...
const CustomerInvoice = require('../../finance/models/CustomerInvoice');
const CustomerReceipt = require('../../finance/models/CustomerReceipt');
const SupplierInvoice = require('../../finance/models/SupplierInvoice');
const SupplierPayment = require('../../finance/models/SupplierPayment');
const CompanyInvoiceToDistributor = require('../../finance/models/CompanyInvoiceToDistributor');
const CompanyReceiptFromDistributor = require('../../finance/models/CompanyReceiptFromDistributor');
const GoodsReceipt = require('../../procurement/models/GoodsReceipt');
const ReturnDocument = require('../../returns/models/ReturnDocument');
const Expense = require('../../finance/models/Expense');
const Account = require('../../finance/models/Account');
const User = require('../../../platform/users/models/User');
const Product = require('../../products/models/Product');
const Warehouse = require('../../warehouse/models/Warehouse');
const Vehicle = require('../../../logistics/fleet/models/Vehicle');
