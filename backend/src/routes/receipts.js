...
const { postCustomerInvoice } = require('../services/posting/postCustomerInvoice');
const { postCompanyInvoiceToDistributor } = require('../services/posting/postCompanyInvoiceToDistributor');
