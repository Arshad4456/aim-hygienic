...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  distributor: { dashboard: { actions: ["view"], scope: "own" }, "primary-sales-orders": { actions: ["view", "create", "print"], scope: "own" }, "primary-orders": { actions: ["view", "create", "print"], scope: "own" }, "secondary-sales-orders": { actions: ["view", "create", "edit", "print"], scope: "own" }, "secondary-orders": { actions: ["view", "create", "edit", "print"], scope: "own" }, inventory: { actions: ["view"], scope: "own" }, receipts: { actions: ["view", "create", "print"], scope: "own" }, reports: { actions: ["view", "export"], scope: "own" }, "live-tracking": { actions: ["view", "track"], scope: "own" } },
  salesman: { dashboard: { actions: ["view"], scope: "own" }, customers: { actions: ["view", "create", "edit"], scope: "own" }, "secondary-sales-orders": { actions: ["view", "create"], scope: "own" }, "secondary-orders": { actions: ["view", "create"], scope: "own" }, receipts: { actions: ["view", "create", "print"], scope: "own" }, "live-tracking": { actions: ["track"], scope: "own" } },
  "order booker": { dashboard: { actions: ["view"], scope: "own" }, customers: { actions: ["view", "create", "edit"], scope: "own" }, "secondary-sales-orders": { actions: ["view", "create"], scope: "own" }, "secondary-orders": { actions: ["view", "create"], scope: "own" }, receipts: { actions: ["view", "create"], scope: "own" }, "live-tracking": { actions: ["track"], scope: "own" } },
