...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  "purchase manager": { dashboard: { actions: ["view"], scope: "company" }, procurement: { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, "purchase-orders": { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, "goods-receipts": { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, "supplier-payments": { actions: ["view", "create", "approve", "print"], scope: "company" }, reports: { actions: ["view", "export"], scope: "company" }, notifications: { actions: ["view", "create"], scope: "company" } },
  ...
  "brand manager": { dashboard: { actions: ["view"], scope: "company" }, "primary-sales-orders": { actions: ["view", "create", "print"], scope: "company" }, returns: { actions: ["view", "create"], scope: "company" }, messages: { actions: ["view", "create"], scope: "company" }, notifications: { actions: ["view", "create"], scope: "company" } }
};
