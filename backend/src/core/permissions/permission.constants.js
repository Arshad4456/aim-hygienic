...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  ceo: {
    ...
    inventory: { actions: ["view", "export"], scope: "company" }, sales: { actions: ["view", "export"], scope: "company" }, "live-tracking": { actions: ["view", "track"], scope: "company" }
  },

  "purchase manager": { dashboard: { actions: ["view"], scope: "company" }, procurement: { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, "purchase-orders": { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, "goods-receipts": { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, "supplier-payments": { actions: ["view", "create", "approve", "print"], scope: "company" }, reports: { actions: ["view", "export"], scope: "company" } },
  "finance manager": { dashboard: { actions: ["view"], scope: "company" }, finance: { actions: ["view", "create", "edit", "approve", "export", "print"], scope: "company" }, receipts: { actions: ["view", "create", "edit", "print"], scope: "company" }, payments: { actions: ["view", "create", "edit", "approve", "print"], scope: "company" }, reports: { actions: ["view", "export"], scope: "company" } },
  ...
  distributor: { dashboard: { actions: ["view"], scope: "own" }, "primary-sales-orders": { actions: ["view", "create", "print"], scope: "own" }, "secondary-sales-orders": { actions: ["view", "create", "edit", "print"], scope: "own" }, inventory: { actions: ["view"], scope: "own" }, customers: { actions: ["view", "create", "edit"], scope: "own" }, receipts: { actions: ["view", "create", "print"], scope: "own" }, reports: { actions: ["view", "export"], scope: "own" }, "live-tracking": { actions: ["view", "track"], scope: "own" } },
  salesman: { dashboard: { actions: ["view"], scope: "own" }, customers: { actions: ["view", "create", "edit"], scope: "own" }, "secondary-sales-orders": { actions: ["view", "create"], scope: "own" }, receipts: { actions: ["view", "create", "print"], scope: "own" }, deliveries: { actions: ["view"], scope: "own" }, "live-tracking": { actions: ["track"], scope: "own" } },
  "order booker": { dashboard: { actions: ["view"], scope: "own" }, customers: { actions: ["view", "create", "edit"], scope: "own" }, "secondary-sales-orders": { actions: ["view", "create"], scope: "own" }, receipts: { actions: ["view", "create"], scope: "own" }, "live-tracking": { actions: ["track"], scope: "own" } },
  "warehouse manager": { dashboard: { actions: ["view"], scope: "warehouse" }, warehouse: { actions: ["view", "create", "edit", "approve", "print"], scope: "warehouse" }, inventory: { actions: ["view", "create", "edit", "approve", "export"], scope: "warehouse" }, dispatches: { actions: ["view", "create", "edit", "approve", "print"], scope: "warehouse" }, "goods-receipts": { actions: ["view", "create", "edit", "approve", "print"], scope: "warehouse" } },
  "delivery boy": { dashboard: { actions: ["view"], scope: "own" }, deliveries: { actions: ["view", "edit", "print"], scope: "own" }, dispatches: { actions: ["view"], scope: "own" }, "live-tracking": { actions: ["track"], scope: "own" } },
  customer: { dashboard: { actions: ["view"], scope: "own" }, "customer-orders": { actions: ["view", "create", "print"], scope: "own" }, receipts: { actions: ["view", "print"], scope: "own" }, returns: { actions: ["view", "create"], scope: "own" } },
  supplier: { dashboard: { actions: ["view"], scope: "own" }, procurement: { actions: ["view", "create", "print"], scope: "own" }, "purchase-orders": { actions: ["view", "print"], scope: "own" }, messages: { actions: ["view", "create"], scope: "own" } },
  "brand manager": { dashboard: { actions: ["view"], scope: "company" }, "primary-sales-orders": { actions: ["view", "create", "print"], scope: "company" }, returns: { actions: ["view", "create"], scope: "company" }, messages: { actions: ["view", "create"], scope: "company" } }
};
