const Notification = require("../../core/notifications/notification.model");
const Message = require("../../models/Message");
const { asText, normalizeRole, isSystemLevelAdmin, getScopedModels } = require("../../services/scopedModels");
const { CHANNELS, EVENT_TEMPLATES } = require("./notifications.constants");
