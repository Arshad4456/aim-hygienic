...
const dashboardLinks = [{ title: 'Dashboard', route: 'manageDirector:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'Managing Director';
  const userRole = user?.role || 'Managing Director';
