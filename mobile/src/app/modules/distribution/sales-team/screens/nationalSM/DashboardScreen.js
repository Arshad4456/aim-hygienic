...
const dashboardLinks = [{ title: 'Dashboard', route: 'nationalSM:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'National Sale Manager';
  const userRole = user?.role || 'National Sale Manager';
