...
const dashboardLinks = [{ title: 'Dashboard', route: 'territorySM:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'Territory Sale Manager';
  const userRole = user?.role || 'Territory Sale Manager';
