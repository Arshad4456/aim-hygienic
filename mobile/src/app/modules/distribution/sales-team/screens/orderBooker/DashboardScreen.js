...
import DutyTrackingCard from '../../../../logistics/live-tracking/tracking/DutyTrackingCard';

const dashboardLinks = [
  { title: 'Dashboard', route: 'orderBooker:dashboard' },
  { title: 'Secondary Sale Requests', route: 'orderBooker:orders' },
  { title: 'Receipts', route: 'orderBooker:receipts' },
];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'Order Booker';
  const userRole = user?.role || 'Order Booker';
      ...
      <Card>
        ...
        <View style={styles.headerRow}>
          <View style={styles.headerTextWrap}>
            <Text style={styles.title}>Order Booker Dashboard</Text>
