...
const dashboardLinks = [
  ...
  { title: 'Order Requests', route: 'customer:orders' },
  { title: 'Receipts', route: 'customer:receipts' },
  { title: 'Account Settings', route: 'customer:settings' },
  { title: 'Change Password', route: 'customer:settings/change-password' },
];
