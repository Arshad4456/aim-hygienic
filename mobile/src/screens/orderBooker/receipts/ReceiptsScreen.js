...
export default function ReceiptsScreen() {
  ...
  const pendingCount = useMemo(() => rows.filter((r) => String(r.status || '').toLowerCase() === 'pending').length, [rows]);
  ...
  return (
    <ScrollView contentContainerStyle={styles.content}>
      <Card>
        <Text style={styles.title}>Order Booker Receipts</Text>
        ...
        {form.paymentMethod === 'online' ? (
          <Selector
            ...
            value={form.paidToAccountId}
            onChange={(v) => setForm((s) => ({ ...s, paidToAccountId: v }))}
        ...
        {form.paymentMethod === 'cash' ? (
          <Selector
            ...
            onChange={(v) => setForm((s) => ({ ...s, receivedByUserId: v }))}
        ...
        {form.paymentMethod === 'cash' ? (
          <Input
            ...
            onChangeText={(v) => setForm((s) => ({ ...s, receivedByName: v }))}
          />
        ) : null}
        ...
        <Input
          ...
          onChangeText={(v) => setForm((s) => ({ ...s, paymentDate: v }))}
        ...
        <Input
          ...
          onChangeText={(v) => setForm((s) => ({ ...s, referenceNo: v }))}
        />
