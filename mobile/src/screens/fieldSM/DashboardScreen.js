...
const dashboardLinks = [{ title: 'Dashboard', route: 'fieldSM:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'Field Sale Manager';
  const userRole = user?.role || 'Field Sale Manager';
