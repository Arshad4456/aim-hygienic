...
const dashboardLinks = [{ title: 'Dashboard', route: 'regionalSM:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'Regional Sale Manager';
  const userRole = user?.role || 'Regional Sale Manager';
