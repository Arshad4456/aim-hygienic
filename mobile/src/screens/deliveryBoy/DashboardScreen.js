...
const dashboardLinks = [{ title: 'Dashboard', route: 'deliveryBoy:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'Delivery Boy';
  const userRole = user?.role || 'Delivery Boy';
      ...
      <Card>
        ...
        <View style={styles.headerRow}>
          <View style={styles.headerTextWrap}>
            <Text style={styles.title}>Delivey Boy Dashboard</Text>
