...
const dashboardLinks = [{ title: 'Dashboard', route: 'hrAssistant:dashboard' }];
...
export default function DashboardScreen({ navigation }) {
  ...
  const userName = user?.fullName || user?.name || 'HR Assistant';
  const userRole = user?.role || 'HR Assistant';
