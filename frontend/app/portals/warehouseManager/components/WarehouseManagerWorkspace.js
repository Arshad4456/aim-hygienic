    ...
    >
      <div className="space-y-5">
        <PageHeader
          ...
          actions={
            <>
              <Link href="/portals/warehouseManager/goods-receipts" className="rounded-2xl border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-700 hover:border-emerald-300 hover:text-emerald-700">
                Review goods receipts
              </Link>
              <Link href="/portals/warehouseManager/dispatch-preparation" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">
                Prepare dispatch
              </Link>
            </>
          }
