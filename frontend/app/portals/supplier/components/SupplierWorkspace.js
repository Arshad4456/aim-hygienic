      ...
      <div className="space-y-5">
        ...
        <SectionCard title="Workflow checkpoints" description="Use these shortcuts to move between supplier execution, communication, and account settings.">
          <div className="grid gap-4 md:grid-cols-3">
            <QuickLink href="/portals/supplier/primary-orders" title="Open assigned primary orders" description="See line items, invoice view, receipts, and upload POD." />
            <QuickLink href="/portals/supplier/messages" title="Open supplier messages" description="Review latest communication and pending notifications." />
            <QuickLink href="/portals/supplier/settings" title="Manage supplier settings" description="Open account settings and keep supplier profile information current." />
          </div>
        </SectionCard>
