      ...
      <div className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
        ...
        <SectionCard title="Quick actions" description="Jump into the working screens needed during delivery execution.">
          <div className="grid gap-3">
            <Link href="/portals/deliveryBoy/orders" className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4 transition hover:border-emerald-200 hover:bg-emerald-50">
            ...
            <Link href="/portals/deliveryBoy/day-plan" className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4 transition hover:border-emerald-200 hover:bg-emerald-50">
            ...
            <Link href="/portals/deliveryBoy/tracking" className="rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-4 transition hover:border-emerald-200 hover:bg-emerald-50">
    ...
    dispatches: (
      <div className="space-y-5">
        ...
        <SectionCard title="Legacy action screen" description="Continue using the existing POD desk for proof upload and receipt confirmation actions.">
          <Link href="/portals/deliveryBoy/orders" className="inline-flex rounded-2xl bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-emerald-700">Open POD desk</Link>
        </SectionCard>
      </div>
    ),
    tracking: (
        ...
        <PageHeader
          ...
          actions={(
            <>
              ...
              <Link href="/portals/deliveryBoy/orders" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">Open POD desk</Link>
            </>
          )}
        />
