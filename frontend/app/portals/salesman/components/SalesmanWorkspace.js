      ...
      <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <SectionCard title="Quick actions" description="Move straight into the most important field execution modules.">
          <div className="grid gap-3">
            {[
              { title: "Open deliveries", href: "/portals/salesman/deliveries", note: "Dispatch, confirm, and upload POD for assigned deliveries." },
              { title: "Assigned customers", href: "/portals/salesman/customers", note: "Review customers mapped to your field or salesman assignment." },
              { title: "Collections", href: "/portals/salesman/collections", note: "See receipts and customer outstanding before visiting." },
              { title: "Visit status", href: "/portals/salesman/visits", note: "Track visited vs pending customer stops for today." },
            ].map((item) => (
        ...
        <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <SectionCard title="Delivery actions" description="Use the action page for camera/POD workflows and legacy delivery actions that already exist in your project.">
            <div className="space-y-3">
              ...
              <Link href="/portals/salesman/orders" className="inline-flex rounded-2xl bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-emerald-700">
        ...
        <PageHeader
          ...
          actions={
            <>
              ...
              <Link href="/portals/salesman/deliveries" className="rounded-2xl bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-emerald-700">
                Open deliveries
              </Link>
            </>
          }
