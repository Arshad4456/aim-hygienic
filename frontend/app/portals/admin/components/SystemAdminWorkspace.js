    ...
    <div className="space-y-6">
      ...
      <SectionCard title="Company strip" description="Pick one company to inspect platform readiness and module access posture.">
        {companyCards.length ? (
          ...
          <EmptyState title="No companies yet" description="Create a company to start the tenant setup flow." action={<Link href="/portals/admin/companies/add" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">Add new company</Link>} />
        )}
      </SectionCard>
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="mb-3 flex items-center justify-between gap-3">
                  ...
                  <Link href={`/portals/admin/companies/${selectedCompany._id}`} className="rounded-full border border-zinc-200 px-3 py-1.5 text-xs font-semibold text-zinc-700 hover:bg-zinc-50">Manage details</Link>
                </div>
                {moduleLoading ? (
