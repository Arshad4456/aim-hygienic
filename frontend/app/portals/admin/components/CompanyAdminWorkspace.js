...
export default function CompanyAdminWorkspace() {
  ...
  const quickLinks = [
    { title: "Operations command center", href: "/portals/admin/operations", note: "Watch fulfillment, backlog, and execution health." },
    { title: "Procurement & supplier flow", href: "/portals/admin/procurement", note: "Link Purchase Manager, Supplier, and goods-receipt readiness." },
    { title: "Warehouse & inventory", href: "/portals/admin/warehouse-inventory", note: "Monitor company stock, adjustments, and expiry risk." },
    { title: "Logistics & dispatch", href: "/portals/admin/logistics", note: "Prepare dispatch, assign driver/vehicle, and track delivery flow." },
    { title: "Finance & accounts", href: "/portals/admin/finance", note: "Control receivables, payables, invoices, and receipts." },
    { title: "Live tracking", href: "/portals/admin/live-tracking", note: "See field users, logistics movement, and last sync status." },
    { title: "Reports workspace", href: "/portals/admin/reports", note: "Cross-check operations, finance, and stock performance." },
  ];
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Link href="/portals/admin/reports" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
              Open reports
            </Link>
          </>
        }
