  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        actions={(
          <>
            <Link href="/portals/admin/procurement/suppliers" className="rounded-2xl border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50">Back to suppliers</Link>
            <Link href="/portals/admin/procurement/payments" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">Open supplier finance</Link>
          </>
        )}
      />
