  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        actions={(
          <>
            <Link href="/portals/admin/assets/vehicles" className="rounded-2xl border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50">
              Vehicle assignment
            </Link>
            <Link href="/portals/admin/live-tracking" className="rounded-2xl bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800">
              Open live tracking
            </Link>
          </>
        )}
        ...
        <div className="space-y-5">
          <div className="grid gap-5 xl:grid-cols-[0.95fr_1.05fr]">
            <SectionCard title="Live tracking entry" description="Open the dedicated live tracking module for map view, playback, and operator focus.">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <Link href="/portals/admin/live-tracking" className="rounded-2xl bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-800">
                  Open live tracking map
                </Link>
                <Link href="/portals/admin/logistics/routes" className="rounded-2xl border border-zinc-200 px-4 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50">
