    ...
    <AdminShell title="Company Details" user={null}>
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <EmptyState title="Company not found" description="The selected company could not be loaded." action={<button type="button" onClick={() => router.push('/portals/admin/companies')} className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">Back to company list</button>} />
        ) : (
          <>
              ...
              <SectionCard title="Company profile" description="Identity and readiness fields used across the platform.">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Link href="/portals/admin/companies" className="rounded-2xl border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50">Back to company list</Link>
                    <Link href="/portals/admin/module-access" className="rounded-2xl border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50">Open full module access page</Link>
                  </div>
                </div>
              </SectionCard>
