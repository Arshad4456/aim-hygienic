          ...
          <div className="grid gap-5 xl:grid-cols-[1.2fr_0.8fr]">
            ...
            <SectionCard title="Quick actions" description="Jump to the most important distributor store operations.">
              <div className="grid gap-3">
                {[
                  { title: "Primary order request", href: "/portals/distributor/primary-order-request", note: "Ask company for replenishment stock." },
                  { title: "Return stock", href: "/portals/distributor/return-stock", note: "Create and manage distributor return documents." },
                  { title: "Secondary orders", href: "/portals/distributor/orders", note: "Move stock downstream to customer sales." },
                  { title: "Payable to company", href: "/portals/distributor/payments", note: "Review open company invoices and settlement pressure." },
                ].map((item) => (
      ...
      return (
        <div className="space-y-5">
          ...
          <SectionCard title="Continue return workflow" description="Open the dedicated return-stock page to create new return documents or continue approval/posting flow.">
            <Link
              href="/portals/distributor/return-stock"
    ...
    >
      <div className="space-y-5">
        <PageHeader
          ...
          actions={
            <>
              <Link href="/portals/distributor/primary-order-request" className="rounded-2xl border border-zinc-200 px-4 py-2.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-50">
                Request stock
              </Link>
              <Link href="/portals/distributor/return-stock" className="rounded-2xl bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-emerald-700">
                Return stock
              </Link>
            </>
          }
