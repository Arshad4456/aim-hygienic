...
export default function DistributorWorkspace() {
  ...
  const quickActions = [
    { title: "Open secondary orders", href: "/portals/distributor/orders", note: "Approve, dispatch, and monitor customer orders." },
    { title: "Customer receipts", href: "/portals/distributor/receipts", note: "Post receipts and manage customer recovery." },
    { title: "Payable to company", href: "/portals/distributor/payments", note: "Track company settlement and invoice posture." },
    { title: "Distributor expenses", href: "/portals/distributor/expense", note: "Capture discount, field, and operational expenses." },
    { title: "Primary order request", href: "/portals/distributor/primary-order-request", note: "Raise stock demand to company supply side." },
    { title: "Reports workspace", href: "/portals/distributor/reports", note: "Review sales, inventory, finance, and territory performance." },
  ];
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Link href="/portals/distributor/orders" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
              Open orders
            </Link>
          </>
        }
