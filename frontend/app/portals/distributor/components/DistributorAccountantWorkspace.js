      ...
      <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
        ...
        <SectionCard title="Quick actions" description="Move straight into the distributor accountant workflows behind this summary panel.">
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              { title: "Customer receipts", href: "/portals/distributor/receipts", note: "Track collections and receipt activity." },
              { title: "Payable to company", href: "/portals/distributor/payments", note: "Review company invoices and settlement posture." },
              { title: "Distributor expense", href: "/portals/distributor/expense", note: "Continue expense posting and audit review." },
              { title: "Reports", href: "/portals/distributor/reports", note: "Open deeper sales, finance, and performance reports." },
            ].map((action) => (
        ...
        <PageHeader
          ...
          actions={
            <>
              ...
              <Link href="/portals/distributor/receipts" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
                Open receipts
              </Link>
            </>
          }
