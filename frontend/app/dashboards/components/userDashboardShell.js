          ...
          <div className="px-4 md:px-6 py-3 flex flex-col md:flex-row md:items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="hidden md:inline-flex rounded-xl border-none px-3 py-2 text-sm hover:bg-zinc-50"
            ...
            <div className="flex w-full md:w-auto md:min-w-[560px] md:justify-end md:flex-nowrap items-center gap-3">
              <div className="relative w-full md:flex-1 md:min-w-[260px] md:max-w-[300px]">
                <input
                  value={query}
...
function UserSidebar({ title, roleKey, groups, pathname, openGroups, setOpenGroups, collapsed, onNavigate }) {
  ...
  return (
    <aside className={["h-screen border-r bg-white flex flex-col", collapsed ? "w-[76px]" : "w-[230px]"].join(" ")}>
      <div className="px-3 pt-3 pb-6 border-none">
