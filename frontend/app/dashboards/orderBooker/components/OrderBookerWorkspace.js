      ...
      <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <SectionCard title="Quick actions" description="Move straight into the most important order-booker execution modules.">
          <div className="grid gap-3">
            {[
              { title: "Create order (legacy)", href: "/dashboards/orderBooker/orders", note: "Open the current secondary order creation screen." },
              { title: "Assigned customers", href: "/dashboards/orderBooker/customers", note: "Review customers mapped to your field or order-booker assignment." },
              { title: "Collections", href: "/dashboards/orderBooker/collections", note: "See receipts and customer outstanding before visiting." },
              { title: "Visit status", href: "/dashboards/orderBooker/visits", note: "Track visited vs pending customer stops for today." },
              { title: "Receipts (legacy)", href: "/dashboards/orderBooker/receipts", note: "Open the current receipt entry screen." },
            ].map((item) => (
      ...
      <div className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
        ...
        <SectionCard title="Order status snapshot" description="Keep an eye on draft, approved, and completed order flow before moving to deeper order-engine passes.">
          <div className="space-y-3">
            ...
            <Link href="/dashboards/orderBooker/orders" className="mt-3 inline-flex rounded-2xl bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-800">Open legacy order creation</Link>
          </div>
        </SectionCard>
      </div>
    ),
        ...
        <PageHeader
          ...
          actions={
            <>
              ...
              <Link href="/dashboards/orderBooker/orders" className="rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700">
                Open order creation
              </Link>
            </>
          }
