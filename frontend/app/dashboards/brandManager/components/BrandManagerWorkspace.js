...
export default function BrandManagerWorkspace() {
  ...
  const quickActions = [
    { title: "Primary order request", href: "/dashboards/brandManager/primary-order-request", note: "Request direct-channel supply from company stock." },
    { title: "Return stock", href: "/dashboards/brandManager/return-stock", note: "Create and review direct-channel return requests." },
    { title: "Messages", href: "/dashboards/brandManager/messages", note: "Stay connected with company-side communication." },
    { title: "Account settings", href: "/dashboards/brandManager/settings", note: "Keep brand manager account and profile clean." },
  ];
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Link href="/dashboards/brandManager/primary-order-request" className="rounded-2xl bg-amber-500 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-600">
              Request stock
            </Link>
          </>
        }
      ...
      {loading ? (
        ...
        <SectionCard title="Return pressure" description="Brand-side return exposure and quick navigation into the return flow.">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Link href="/dashboards/brandManager/return-stock" className="rounded-3xl border border-zinc-200 bg-white px-4 py-4 shadow-sm transition hover:border-amber-200 hover:bg-amber-50">
