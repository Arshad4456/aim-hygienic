...
export default function ChangePasswordPage() {
  ...
  return (
    <AdminShell title="Change Password" user={null}>
      <div className="rounded-2xl bg-white border shadow-sm p-5 max-w-2xl">
        <div className="text-xl font-semibold text-zinc-900">Change Password</div>
        <div className="text-sm text-zinc-500 mt-1">Use a strong password to secure your account.</div>
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className="mt-1 w-full rounded-xl border px-3 py-2 pr-12 outline-none focus:ring-2 focus:ring-emerald-200"
        />
        <button
          type="button"
          onClick={onToggle}
