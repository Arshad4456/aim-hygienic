        ...
        <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
          <SectionCard title="Quick actions" description="Keep the working order-request and receipt entry screens alive while using the new customer dashboard for visibility.">
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                { title: "Order request desk", href: "/dashboards/customer/orders", note: "Open the existing order request flow." },
                { title: "Receipt desk", href: "/dashboards/customer/receipts", note: "Open the existing receipt submission flow." },
                { title: "Invoice visibility", href: "/dashboards/customer/invoices", note: "Review invoices raised against your orders." },
                { title: "Return requests", href: "/dashboards/customer/returns", note: "Track your return requests and return document status." },
              ].map((item) => (
    ...
    >
      <div className="space-y-5">
        <PageHeader
          ...
          actions={
            <>
              <Link href="/dashboards/customer/orders" className="rounded-2xl border border-zinc-200 px-4 py-2.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-50">
                Order request desk
              </Link>
              <Link href="/dashboards/customer/receipts" className="rounded-2xl bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-emerald-700">
                Receipt desk
              </Link>
            </>
          }
