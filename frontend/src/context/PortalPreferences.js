...
const DICTIONARY = {
  ur: {
    ...
    "Company Control": "کمپنی کنٹرول",
    "Company Control Center": "کمپنی کنٹرول سینٹر",
    "Loading company control center…": "کمپنی کنٹرول سینٹر لوڈ ہو رہا ہے…",
  ...
  ar: {
    ...
    "Company Control": "إدارة الشركة",
    "Company Control Center": "مركز إدارة الشركة",
    "Loading company control center…": "جاري تحميل مركز إدارة الشركة…",
