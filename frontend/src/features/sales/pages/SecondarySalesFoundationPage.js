...
export default function SecondarySalesFoundationPage() {
  ...
  return <div className="space-y-6">
    <div className="rounded-[2rem] bg-gradient-to-r from-emerald-50 via-cyan-50 to-blue-50 p-6 ring-1 ring-cyan-100"><p className="text-xs font-black uppercase tracking-[0.35em] text-emerald-600">Phase 7 Secondary Sales</p><h2 className="mt-2 text-3xl font-black text-slate-950">Distributor → Customer</h2><p className="mt-2 max-w-4xl text-sm text-slate-600">Distributor stock is separate from company stock. Select a distributor to see that distributor warehouse stock and create customer orders.</p></div>
