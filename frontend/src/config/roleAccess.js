...
const ROLE_PROFILES = {
  ...
  "purchase manager": {
    ...
    moduleKeys: ["dashboard", "suppliers", "products", "procurement", "purchase-orders", "supplier-payments", "goods-receipts", "inventory", "warehouse", "reports", "settings"],
  },
  "finance / accounts": {
  ...
  "brand manager": {
    ...
    moduleKeys: ["dashboard", "products", "customers", "primary-sales-orders", "returns", "notifications", "reports", "settings"],
  },
  distributor: {
    label: "Distributor",
    scope: "distributor",
  ...
  supplier: {
    ...
    moduleKeys: ["dashboard", "procurement", "purchase-orders", "notifications", "settings"],
  },
  customer: {
    label: "Customer",
    scope: "customer",
