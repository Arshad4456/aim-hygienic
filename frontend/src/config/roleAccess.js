...
const ROLE_PROFILES = {
  ...
  "warehouse manager": {
    ...
    moduleKeys: ["dashboard", "warehouse", "warehouses", "inventory", "goods-receipts", "dispatches", "returns", "manufacturing", "reports", "settings"],
  },
  "brand manager": {
    label: "Brand Manager",
    scope: "company",
    homePath: "/portals/sales/primary-orders",
    moduleKeys: ["dashboard", "products", "customers", "sales-quotations", "primary-sales-orders", "retail-pos", "returns", "notifications", "reports", "settings"],
  },
  distributor: {
    label: "Distributor",
    scope: "distributor",
